<?php
	...
	include_once "extentios/e-registration.php";
	if($_SERVER['REQUEST_METHOD']=='POST' && ($pass==$passconfirm)) {echo '<meta http-equiv="refresh" content="3;http://weblab.teipir.gr/~www33175/index.php"/>';}	
