...
<tr><td><input type="text" name="input_search" id="input_search"  value=""  size="20" maxlength="80"/></td><td><input type="submit" name="searchButton" id="searchButton" value="Αναζήτηση"/></tr></table></form>
</div>